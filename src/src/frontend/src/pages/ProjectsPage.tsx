...
import { ArrowRight, Film, FolderOpen, Plus, Trash2 } from "lucide-react";
        ...
        <AnimatePresence>
          <div className="space-y-3" data-ocid="projects.list">
            {projects.map((project, i) => (
              ...
              >
                <Card
                  className="bg-card border-border hover:border-primary/40 transition-all cursor-pointer group scene-card-hover"
                  onClick={() =>
                    navigate({
