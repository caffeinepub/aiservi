...
import type { ReplicateApiKey as _ReplicateApiKey, Scene as _Scene, SceneStatus as _SceneStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addScene(arg0: string, arg1: string): Promise<Scene> {
        if (this.processError) {
            try {
                const result = await this.actor.addScene(arg0, arg1);
                return from_candid_Scene_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async deleteScene(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteScene(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReplicateApiKey(arg0: Principal): Promise<ReplicateApiKey | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getReplicateApiKey(arg0);
    ...
    async getScenesForProject(arg0: string): Promise<Array<Scene>> {
        if (this.processError) {
            try {
                const result = await this.actor.getScenesForProject(arg0);
    ...
    async reorderScenes(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderScenes(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeReplicateApiKey(arg0: ReplicateApiKey): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeReplicateApiKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createReplicatePrediction(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createReplicatePrediction(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async pollReplicatePrediction(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.pollReplicatePrediction(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_SceneStatus_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SceneStatus): SceneStatus {
    return from_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function from_candid_Scene_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Scene): Scene {
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReplicateApiKey]): ReplicateApiKey | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_SceneStatus_n10(_uploadFile, _downloadFile, value.status),
        order: value.order,
        replicateJobId: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.replicateJobId)),
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? SceneStatus.pending : "done" in value ? SceneStatus.done : "generating" in value ? SceneStatus.generating : "error" in value ? SceneStatus.error : value;
}
...
function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Scene>): Array<Scene> {
    return value.map((x)=>from_candid_Scene_n8(_uploadFile, _downloadFile, x));
}
